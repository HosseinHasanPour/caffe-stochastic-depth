stoch_test_acc_time54 = open('../54net/stoch_test_acc_time54.txt', 'w+')
stoch_test_acc_time_diffs54 = open('../54net/stoch_test_acc_time_diffs54.txt', 'w+')
# from dateutil import parser
import datetime
import time

with open("stoch54_gpu1_db1.txt") as f:
    data = f.read()
...
reg_test_acc_time54 = open('../54net/reg_test_acc_time54.txt', 'w+')
reg_test_acc_time_diffs54 = open('../54net/reg_test_acc_time_diffs54.txt', 'w+')

with open("reg54_gpu0_db0.txt") as f:
    data = f.read()
