...
def make_net(stages, device):
    ...
    with open('examples/python_stoch_dep/residual_train.prototxt', 'w') as f:
        print(str(resnet('/scratch/pas282/caffe/examples/cifar10_train_leveldb_padding3', stages=stages, batch_size=128)), file=f)

    with open('examples/python_stoch_dep/residual_test.prototxt', 'w') as f:
        print(str(resnet('/scratch/pas282/caffe/examples/cifar10_train_leveldb_padding3', stages=stages, batch_size=100)), file=f)
